...
As stated above, I am currently using the default WEBrick server that comes pre-configured with RoR. And
if you do not already know how to start a rails application, follow these steps:
